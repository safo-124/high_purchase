...
export function ConversationList({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-slate-50/50 to-white dark:from-slate-900/50 dark:to-slate-950">
      {/* Header */}
      <div className="px-5 py-5 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button 
            ...
            className="rounded-xl bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 shadow-lg shadow-violet-500/25 border-0"
          >
        ...
        <div className="relative">
          ...
          <Input
            ...
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="pl-11 h-11 rounded-xl bg-slate-100/80 dark:bg-slate-800/80 border-0 focus-visible:ring-2 focus-visible:ring-violet-500/50"
          />
        </div>
      </div>
...
export function MessageThread({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-slate-50 to-slate-100/50 dark:from-slate-900 dark:to-slate-950">
      ...
      {/* Header */}
      <div className="flex items-center gap-4 px-5 py-4 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
        <Button 
          variant="ghost" 
          size="icon" 
          onClick={onBack} 
        ...
        <div className="relative">
          <div className={cn(
            "h-11 w-11 rounded-xl flex items-center justify-center text-white font-semibold text-sm shadow-lg bg-gradient-to-br",
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="font-semibold text-slate-900 dark:text-white truncate">{conversationName}</h3>
            {conversationRole && (
              <Badge 
                variant="outline" 
                className={cn("text-[10px] px-1.5 py-0 h-5 border", getRoleBadgeStyle(conversationRole))}
              >
      ...
      {/* Message Input */}
      <div className="p-4 border-t border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
        <div className="flex gap-3 items-end">
          <div className="flex-1 relative">
            <Textarea
              ...
              className="min-h-[52px] max-h-[140px] resize-none rounded-2xl pr-4 pl-4 py-3.5 bg-slate-100/80 dark:bg-slate-800/80 border-0 focus-visible:ring-2 focus-visible:ring-violet-500/50 text-sm"
              rows={1}
            />
          </div>
          <Button
            ...
            size="icon"
            className={cn(
              "shrink-0 h-[52px] w-[52px] rounded-2xl transition-all",
              newMessage.trim() 
...
export function MessagingPage({
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-12rem)] md:h-[calc(100vh-10rem)]">
      <Card className="flex-1 flex flex-col overflow-hidden rounded-2xl border-slate-200/60 dark:border-slate-800/60 shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50">
