import { ShopEmailLogData } from "../../email-actions"
import { EmailStatus } from "../../../generated/prisma/client"

interface ShopEmailLogsListProps {
  logs: ShopEmailLogData[]
}
...
export function ShopEmailLogsList({ logs }: ShopEmailLogsListProps) {
  return (
