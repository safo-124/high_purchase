...
import { confirmPayment, rejectPayment, type PaymentForAdmin } from "../../actions"

interface PaymentsContentProps {
  payments: PaymentForAdmin[]
  shopSlug: string
  stats: {
...
export function PaymentsContent({
  ...
  const [selectedPayment, setSelectedPayment] = useState<PaymentForAdmin | null>(null)
  ...
  const handleTabChange = (tab: "pending" | "confirmed" | "rejected") => {
    ...
    router.push(`/shop-admin/${shopSlug}/pending-payments?${params.toString()}`)
  }
  ...
  const openRejectModal = (payment: PaymentForAdmin) => {
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="px-3 py-2 rounded-xl bg-slate-800 border border-white/10 text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
            />
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-indigo-500/20 text-indigo-400 text-sm font-medium hover:bg-indigo-500/30 transition-all"
          >
            Apply Filter
          </button>
          {(dateStart || dateEnd) && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="glass-card rounded-2xl p-6 w-full max-w-md">
            ...
            <p className="text-sm text-slate-400 mb-4">
              ...
              <span className="text-white">{selectedPayment.collectorName || "Unknown"}</span>.
            </p>
