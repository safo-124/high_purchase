...
export function ShopAdminSidebar({ shopSlug, shopName, userName, userEmail, businessName, businessLogoUrl }: ShopAdminSidebarProps) {
  ...
  const navItems = [
    ...
    {
      name: "Invoices",
      href: `/shop-admin/${shopSlug}/purchase-invoices`,
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      name: "Receipts",
      href: `/shop-admin/${shopSlug}/receipts`,
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 glass-card border-b border-white/10">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            {businessLogoUrl ? (
              <div className="w-9 h-9 rounded-lg overflow-hidden bg-white/10 border border-violet-500/30">
                <Image
                  src={businessLogoUrl}
                  alt={businessName}
                  width={36}
      ...
      <div className="p-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          {businessLogoUrl ? (
            <div className="w-10 h-10 rounded-xl overflow-hidden bg-white/10 border border-violet-500/30 shadow-lg shadow-violet-500/10">
              <Image
                src={businessLogoUrl}
                alt={businessName}
                width={40}
