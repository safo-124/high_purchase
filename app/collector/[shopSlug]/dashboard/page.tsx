  ...
  return (
    <div className="p-3 sm:p-6 max-w-5xl mx-auto">
      <div className="mb-4 sm:mb-6">
        <h1 className="text-lg sm:text-2xl font-bold text-white mb-0.5 sm:mb-1">Dashboard</h1>
        <p className="text-xs sm:text-sm text-slate-400">Welcome back, {dashboard.collectorName}</p>
      </div>
