    ...
    <>
      <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
        ...
        <div className="glass-card rounded-2xl p-4 sm:p-6">
          ...
          <div className="space-y-4">
            <select
              ...
              required
              className="w-full px-4 py-3 rounded-xl bg-slate-800 border border-white/10 text-white focus:outline-none focus:border-emerald-500/50 text-sm sm:text-base"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm text-emerald-400 hover:text-emerald-300 active:text-emerald-500 transition-colors py-1"
            >
        ...
        <div className="glass-card rounded-2xl p-4 sm:p-6">
          ...
          <div className="space-y-4">
            ...
            {/* Product and Quantity Selection - Stack on mobile */}
              ...
              <div className="flex gap-2 sm:gap-3">
                <div className="w-20 sm:w-24">
                  <input
                    ...
                    placeholder="Qty"
                    className="w-full px-3 sm:px-4 py-3 rounded-xl bg-slate-800 border border-white/10 text-white focus:outline-none focus:border-emerald-500/50 text-center"
                  />
                </div>
                <button
                  type="button"
                  ...
                  className="flex-1 sm:flex-none px-4 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-700 disabled:cursor-not-allowed text-white font-medium transition-all flex items-center justify-center gap-2"
                >
        ...
        {cart.length > 0 && (
          <div className="glass-card rounded-2xl p-4 sm:p-6">
            ...
            <div className="space-y-3">
              {cart.map((item) => (
                <div key={item.productId} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10 gap-3">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-red-400 hover:text-red-300 hover:bg-red-500/10 active:bg-red-500/20 transition-all flex-shrink-0"
                  >
        ...
        {/* Payment Terms */}
        <div className="glass-card rounded-2xl p-4 sm:p-6">
          <h2 className="text-base sm:text-lg font-semibold text-white mb-4">Payment Terms</h2>
            ...
            <div className="space-y-3">
              ...
              {cart.map((item) => (
                <div key={item.productId} className="flex justify-between text-sm gap-2">
                  <span className="text-slate-400 truncate">{item.productName} × {item.quantity}</span>
                  <span className="text-white flex-shrink-0">₵{item.totalPrice.toLocaleString()}</span>
                </div>
              ))}
              ...
              <div className="flex justify-between text-base sm:text-lg border-t border-white/10 pt-3">
      ...
      {showNewCustomer && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
          ...
          <div className="relative glass-card rounded-t-2xl sm:rounded-2xl p-5 sm:p-6 w-full sm:max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg sm:text-xl font-bold text-white">Add New Customer</h3>
              <button
            ...
            <form onSubmit={handleNewCustomer} className="space-y-4">
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 py-2.5 rounded-xl bg-slate-800 border border-white/10 text-white focus:outline-none focus:border-emerald-500/50"
                  />
                </div>
                <div>
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
                <button
                  type="button"
                  onClick={() => setShowNewCustomer(false)}
                  className="hidden sm:block px-4 py-2.5 rounded-xl bg-white/5 text-slate-300 hover:bg-white/10 transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-medium disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                >
                  {newCustomerLoading ? (
                    <>
