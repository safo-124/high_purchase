...
export default async function CollectorProductsPage({ params }: CollectorProductsPageProps) {
  ...
  return (
    <div className="p-4 sm:p-6">
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2">Products</h1>
        <p className="text-sm sm:text-base text-slate-400">View available products and their stock levels</p>
      </div>
