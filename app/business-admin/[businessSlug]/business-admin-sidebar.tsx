    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: `${baseUrl}/scheduled-reports`,
          icon: (
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <>
      ...
      <div className="px-4 py-3 border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <button onClick={toggleTheme} className="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white transition-all border border-white/5" title={isLightMode ? "Dark Mode" : "Light Mode"}>
            {isLightMode ? (
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
