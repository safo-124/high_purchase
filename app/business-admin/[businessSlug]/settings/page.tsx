        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-3">
              <a
                href={`/business-admin/${businessSlug}/settings/account`}
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-white font-medium group-hover:text-red-300 transition-colors">Account Security</p>
                  <p className="text-xs text-slate-500">Email & password</p>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-white font-medium group-hover:text-violet-300 transition-colors">Business Profile</p>
                  <p className="text-xs text-slate-500">Logo, name & contact info</p>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-white font-medium group-hover:text-orange-300 transition-colors">Email Settings</p>
                  <p className="text-xs text-slate-500">Configure SMTP</p>
                </div>
                <svg className="w-5 h-5 text-slate-500 group-hover:text-orange-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </a>
              
              <a
                href={`/business-admin/${businessSlug}/settings/sms`}
                className="flex items-center gap-3 p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-colors group"
              >
                ...
                <div className="flex-1">
                  <p className="text-white font-medium group-hover:text-blue-300 transition-colors">SMS Settings</p>
                  <p className="text-xs text-slate-500">Configure SMS gateway</p>
                </div>
              ...
              <a
                href={`/business-admin/${businessSlug}/settings/payment`}
                className="flex items-center gap-3 p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-colors group"
              >
                ...
                <div className="flex-1">
                  <p className="text-white font-medium group-hover:text-emerald-300 transition-colors">Payment Configuration</p>
                  <p className="text-xs text-slate-500">Bank & Mobile Money details</p>
                </div>
              ...
              <a
                href={`/business-admin/${businessSlug}/settings/accountants`}
                className="flex items-center gap-3 p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-colors group"
              >
                ...
                <div className="flex-1">
                  <p className="text-white font-medium group-hover:text-teal-300 transition-colors">Accountants</p>
                  <p className="text-xs text-slate-500">Manage financial access</p>
                </div>
                <svg className="w-5 h-5 text-slate-500 group-hover:text-teal-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </a>
            </div>
