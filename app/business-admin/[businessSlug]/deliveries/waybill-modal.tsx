...
import { getBusinessWaybill } from "../../actions"
...
export function WaybillModal({ businessSlug, purchaseId, onClose }: WaybillModalProps) {
  ...
  useEffect(() => {
    async function loadWaybill() {
      try {
        const data = await getBusinessWaybill(businessSlug, purchaseId)
        setWaybill(data)
      } catch (error) {
          ...
          <>
            ...
            <div className="flex items-center justify-between mb-6 no-print">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={handlePrint}
                  className="px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg text-sm font-medium flex items-center gap-2"
                >
            ...
            <div ref={printRef} className="text-gray-900">
              ...
              <div className="mt-10">
                ...
                <div className="grid grid-cols-2 gap-10">
                  ...
                  <div>
                    <div className="mb-2">
                      <label className="text-xs text-gray-500 uppercase block">Staff</label>
                      <span className="text-sm font-medium text-gray-900">{waybill.generatedByName || "-"}</span>
                    </div>
                  ...
                  <div>
                    <div className="mb-2">
                      <label className="text-xs text-gray-500 uppercase block">Authorized By</label>
