...
import { changeCustomerEmail, changeCustomerPassword, CustomerSettingsData } from "@/app/customer/actions"
import { Mail, Lock, Eye, EyeOff, Shield, AlertTriangle, User, Phone, Calendar } from "lucide-react"

interface CustomerSettingsContentProps {
  settings: CustomerSettingsData
}

export function CustomerSettingsContent({ settings }: CustomerSettingsContentProps) {
          ...
          <div className="glass-card p-6">
            ...
            <div className="mt-4 pt-4 border-t border-white/10">
              <div className="flex items-center gap-2 text-sm text-slate-400">
                ...
                Member since {new Date(settings.createdAt).toLocaleDateString("en-GB", {
                  day: "numeric",
                  month: "long",
                  year: "numeric"
                })}
