...
import { CustomerMessagingPage } from "@/components/messaging/customer-messaging"
        ...
        <main className="w-full px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-6">
            ...
            <p className="text-slate-400">
              Chat with our shop staff
            </p>
          </div>

          <CustomerMessagingPage customerId={dashboardData.customer.id} />
        </main>
      </div>
    </div>
  )
