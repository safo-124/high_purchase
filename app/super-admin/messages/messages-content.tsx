        ...
        <div className="w-full px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/super-admin" className="w-11 h-11 rounded-xl logo-glow flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">{data.unreadCount} unread · {data.total} total</p>
              </div>
            </div>
            <nav className="hidden md:flex items-center gap-2">
              <Link href="/super-admin" className="nav-link text-slate-300 hover:text-white text-sm">Dashboard</Link>
              <Link href="/super-admin/registrations" className="nav-link text-slate-300 hover:text-white text-sm">Registrations</Link>
              <Link href="/super-admin/messages" className="nav-link active text-white text-sm font-medium">Messages</Link>
              <Link href="/super-admin/businesses" className="nav-link text-slate-300 hover:text-white text-sm">Businesses</Link>
            </nav>
          </div>
        </div>
      </header>

      <main className="relative z-10 w-full px-6 py-8 max-w-7xl mx-auto">
        {/* Filters */}
