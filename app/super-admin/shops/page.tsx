...
export default async function ShopsPage() {
  ...
  const suspendedCount = shops.length - activeCount
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-2">
              ...
              <Link href="/super-admin/shops" className="nav-link active text-white text-sm font-medium">
                Shops
              </Link>
            </nav>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white tracking-tight">Shops</h2>
              </div>
            </div>
            <p className="text-slate-400">Manage all tenant shops on the High Purchase platform</p>
          </div>
          <CreateShopDialog />
        </div>
        ...
        <div className="glass-card overflow-hidden">
          <div className="p-6 border-b border-white/5">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-white">All Shops</h3>
                <p className="text-sm text-slate-400">{shops.length} shop{shops.length !== 1 ? "s" : ""} registered</p>
              </div>
          ...
          {shops.length === 0 ? (
            <div className="text-center py-16 px-6">
              ...
              <p className="text-slate-400 mb-6 max-w-sm mx-auto">
                Create your first shop to start managing tenants on the High Purchase platform
              </p>
              <CreateShopDialog />
            </div>
          ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-white/[0.02]">
                    ...
                    <th className="px-6 py-4 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">Country</th>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-300">{shop.country}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
